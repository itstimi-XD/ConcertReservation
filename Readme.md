...
10. [쿼리 성능 개선 보고서](#쿼리-성능-개선-보고서)
11. [서비스 확장성을 위한 아키텍처 설계](#서비스-확장성을-위한-아키텍처-설계)
12. [카프카 그리고 테스트 컨테이너 그 사이 어딘가](#카프카-그리고-테스트-컨테이너-그-사이-어딘가)
---
...
프로젝트의 **쿼리 성능 개선 시도' 작업**에 대한 자세한 슬픈 이야기는 아래 문서에서 확인하실 수 있습니다.

- [쿼리 성능 개선 보고서](./document/query_performance_report.md)

## 서비스 확장성을 위한 아키텍처 설계
- [서비스 확장성을 위한 아키텍처 설계](./document/service_design_document.md)

## 카프카 그리고 테스트 컨테이너 그 사이 어딘가
- [김인후의 인생 첫 kafka 테스트 컨테이너 도전기](./document/김인후의%20인생%20첫%20kafka%20테스트%20컨테이너%20도전기.md)